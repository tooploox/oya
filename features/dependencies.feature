...
Scenario: Get a specific pack version
  Given file ./Oyafile containing
    ...
    Project: project
    """
  When I run "oya get github.com/tooploox/oya-example-pack@v1.0.0"
  Then the command succeeds
  And file ./.oya/vendor/github.com/tooploox/oya-example-pack/Oyafile exists
  And file ./.oya/vendor/github.com/tooploox/oya-example-pack/VERSION contains
    """
    v1.0.0
    """
  And file ./Oyafile contains
    ...
    Project: project
    Require:
      github.com/tooploox/oya-example-pack: v1.0.0
    """
...
Scenario: Get the latest pack version
  Given file ./Oyafile containing
    ...
    Project: project
    """
  When I run "oya get github.com/tooploox/oya-example-pack"
  Then the command succeeds
  And file ./.oya/vendor/github.com/tooploox/oya-example-pack/Oyafile exists
  And file ./.oya/vendor/github.com/tooploox/oya-example-pack/VERSION contains
    """
  ...
  And file ./Oyafile contains
    ...
    Project: project
    Require:
      github.com/tooploox/oya-example-pack: v1.1.1
    """
